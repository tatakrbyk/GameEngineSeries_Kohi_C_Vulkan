...
/**
 * Checks if a file with the given path exist.
...
/**
 * Closes the provided handle to a flie.
 ...
 * @returns True if successfuly; otherwise false.
 */
 ...
 * @returns True if succesful; otherwise false;
  ...
  * @param out_data A pointer to a block of memory yo be populated by this method.
  * @param out_bytes_read A pointer to a number which will be pıpulated with the number of bytes actually read from the file.
