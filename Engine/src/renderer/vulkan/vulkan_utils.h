 ...
 * @param get_extended Indicates whether to also return an sxtended result.
 ...
 * @returns True if success; otherwise false. Defaults to true for unknown result type;
 *
*/
